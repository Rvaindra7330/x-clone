...
export const Auth=({type}:{type:"signup"|"signin"})=>{
    ...
    <div className="col-span-5">
        ...
        <div className='mt-10 text-xl font-semibold font-sans'>
            ...
            <Link to={type==='signup'?"/signin":"/signup"} className="pl-2 underline">{type==='signin'?"Signup":"Signin"}</Link>
        ...
        <div className='pt-5 '>
        <button type="button" className="text-white w-80 bg-sky-500 hover:bg-sky-700 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none">{type==='signup'?"Signup":"Signin"}</button>
